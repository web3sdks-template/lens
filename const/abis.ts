// Learn how we use the web3sdks SDK to connect to the Lens smart contract using it's ABI:
// https://blog.web3sdks.com/guides/how-to-use-any-smart-contract-with-web3sdks-sdk-using-abi/
